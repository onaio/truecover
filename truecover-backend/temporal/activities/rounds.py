...
async def create_round_record(
    ...
    try:
        ...
        # Create round
        cursor.execute("""
            INSERT INTO rounds (area_id, round_number, name, description, start_date, end_date, indicator_id, sampling_target, sampling_method)
            VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)
            RETURNING id, round_number, name, description, start_date, end_date, created_at, updated_at, sampling_target, sampling_method
        """, (area_id, round_number, name, description, start_date, end_date, indicator_id, sampling_target, sampling_method))
